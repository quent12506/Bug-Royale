...
public class Espece {
    ...
    public Espece(String stringEspece, double vitesseDeplacement, int HPParDefaut, BufferedImage sprite, double vitesseProjectile,int degatsProjectile, BufferedImage spriteProjectile, String nomCapacite) {
